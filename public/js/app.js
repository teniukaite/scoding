  ...
  methods: {
    Register: function Register() {
      ...
      if (!this.errors.length) {
        ...
        this.app.req.post('api/auth/login', data).then(function (response) {
          _this.app.user = response.data.user;
          localStorage.setItem('auth', response.data.token); // Išsaugom token'ą

          _this.$parent.$data.user = response.data.user;
          _this.$parent.$data.token = response.data.token;
  ...
  methods: {
    Register: function Register() {
      ...
      if (!this.errors.length) {
        ...
        this.app.req.post('api/auth/register', data).then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchUsers: function fetchUsers(page) {
      ...
      this.$parent.req.post('api/users', info).then(function (response) {
    ...
    deleteUser: function deleteUser(id) {
      ...
      if (confirm('Are you sure?')) {
        this.$parent.req["delete"]("/api/user/".concat(id), {
          params: {
            token: this.$parent.$data.token
          }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      initiated: false,
      token: '',
      req: axios__WEBPACK_IMPORTED_MODULE_1___default.a.create({
        baseUrl: '/'
      })
    };
  },
    ...
    init: function init() {
      ...
      if (this.token !== '') {
        ...
        this.req.post('api/auth/me', {
          ...
          _this.$parent.$data.user = response.data.user;
          _this.$parent.$data.token = _this.token;
          _this.$f.data().user = response.data.user;
          _this.loading = false;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      ...
      this.app.req.post('api/auth/logout', {
        token: this.$parent.$data.token
      }).then(function () {
        _this.app.user = null;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchTasks: function fetchTasks(page) {
      ...
      this.$parent.req.post(page, info).then(function (response) {
    ...
    fetchUsers: function fetchUsers() {
      ...
      this.$parent.req.post('api/allusers', info).then(function (response) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/Login.vue?vue&type=template&id=3d143c20&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/auth/Login.vue?vue&type=template&id=3d143c20&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************/
          ...
          this.errors.length
            ? _c("div", { staticClass: "alert alert-danger" }, [
                _c(
                  "ul",
                  { staticClass: "mb-0" },
                  _vm._l(this.errors, function(error, index) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/Register.vue?vue&type=template&id=d7dc2e88&scoped=true&":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/auth/Register.vue?vue&type=template&id=d7dc2e88&scoped=true& ***!
  \*****************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    ...
    _c("div", { staticClass: "card-body" }, [
        ...
        [
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { id: "name", placeholder: "name", required: "" },
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("option", { domProps: { value: 0 } }, [_vm._v("User")]),
                _vm._v(" "),
      ...
      _vm._v(" "),
      _c("nav", { attrs: { "aria-label": "Users navigation" } }, [
          ...
          _c("ul", { staticClass: "navbar-nav mr-auto" }, [
            _c(
              ...
              [
                _c(
                  "router-link",
                  { staticClass: "nav-link", attrs: { to: { name: "Tasks" } } },
                  [_vm._v("Home")]
                )
              ],
              1
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    ...
    _c("div", { staticClass: "card-body" }, [
        ...
        [
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: {
                disabled: this.$parent.$data.user.type !== 1,
                id: "task",
                placeholder: "Task",
                required: ""
              },
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c(
              ...
              [
                _c("option", { attrs: { disabled: "" } }, [
                  _vm._v("Select user task is for")
                ]),
                _vm._v(" "),
                _vm._l(_vm.users, function(u) {
                  return _c(
                    "option",
                    {
                      domProps: { value: u.id, selected: u === _vm.task.user }
                    },
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c(
              ...
              [
                _c("option", { domProps: { value: 0 } }, [_vm._v("New")]),
                _vm._v(" "),
                _c("option", { domProps: { value: 1 } }, [
                  _vm._v("In progress")
                ]),
                _vm._v(" "),
                _c("option", { domProps: { value: 2 } }, [_vm._v("Done")])
              ]
            )
          ]),
          _vm._v(" "),
      ...
      _vm._v(" "),
      _c("nav", { attrs: { "aria-label": "Tasks navigation" } }, [
        _c("ul", { staticClass: "pagination" }, [
          _c(
            "li",
            {
      ...
      _c("nav", { attrs: { "aria-label": "Tasks navigation" } }, [
        _c("ul", { staticClass: "pagination" }, [
          ...
          _c(
            ...
            {
              staticClass: "page-item",
              class: [{ disabled: this.order === "status" }],
              on: {
                click: function($event) {
          ...
          _c(
            ...
            {
              staticClass: "page-item",
              class: [{ disabled: this.order === "created_at" }],
              on: {
                click: function($event) {
...
/* harmony import */ var _components_Tasks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/Tasks */ "./resources/js/components/Tasks.vue");
/* harmony import */ var _auth_Login__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./auth/Login */ "./resources/js/auth/Login.vue");
/* harmony import */ var _auth_Register__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth/Register */ "./resources/js/auth/Register.vue");
/* harmony import */ var _components_AdminPanel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/AdminPanel */ "./resources/js/components/AdminPanel.vue");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./auth */ "./resources/js/auth.js");
/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./admin */ "./resources/js/admin.js");
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./functions */ "./resources/js/functions.js");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$f = _functions__WEBPACK_IMPORTED_MODULE_9__["f"];
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    meta: {
      middleware: _auth__WEBPACK_IMPORTED_MODULE_7__["default"]
    }
  }, {
    path: '/login',
    name: 'Login',
    ...
    path: '/admin',
    name: 'Admin',
    component: _components_AdminPanel__WEBPACK_IMPORTED_MODULE_6__["default"],
    meta: {
      middleware: _admin__WEBPACK_IMPORTED_MODULE_8__["default"]
    }
  }]
});
...
router.beforeEach(function (to, from, next) {
  if (to.meta.middleware) {
    ...
    if (to.meta.middleware.name === 'auth') {
      return Object(_auth__WEBPACK_IMPORTED_MODULE_7__["default"])(_objectSpread(_objectSpread({}, context), {}, {
        next: next
      }));
    } else if (to.meta.middleware.name === 'admin') {
      return Object(_admin__WEBPACK_IMPORTED_MODULE_8__["default"])(_objectSpread(_objectSpread({}, context), {}, {
        next: next,
        user: app.user
      }));
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_3d143c20_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Login.vue?vue&type=template&id=3d143c20&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/Login.vue?vue&type=template&id=3d143c20&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_3d143c20_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_3d143c20_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Register_vue_vue_type_template_id_d7dc2e88_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Register.vue?vue&type=template&id=d7dc2e88&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/Register.vue?vue&type=template&id=d7dc2e88&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Register_vue_vue_type_template_id_d7dc2e88_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Register_vue_vue_type_template_id_d7dc2e88_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
var f = {
  data: function data() {
    return {
      user: null,
      token: '',
      req: axios__WEBPACK_IMPORTED_MODULE_0___default.a.create({
        baseUrl: '/'
      })
    };
  },
...
__webpack_require__(/*! C:\wamp64\www\task\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\task\resources\sass\app.scss */"./resources/sass/app.scss");
